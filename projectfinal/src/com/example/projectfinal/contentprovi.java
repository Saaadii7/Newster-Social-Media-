...
public class contentprovi extends ContentProvider {
	 ...
	 static final String PROVIDER_NAME = "com.projectfinal.provider.login";
	 ...
	 static final UriMatcher uriMatcher;
	   static{
	      ...
	      uriMatcher.addURI(PROVIDER_NAME, "news", LOGIN);
	      uriMatcher.addURI(PROVIDER_NAME, "news/#", LOGIN_ID);
	   }
	   
	   // database declarations
	   private SQLiteDatabase database;
	   static final String DATABASE_NAME = "login";
	   static final String TABLE_NAME = "logindb";
